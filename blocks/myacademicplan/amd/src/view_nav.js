...
function(
    ...
    var updatePreferences = function(filter, value) {
        var type = null;
        if (filter == 'display') {
            type = 'block_myacademicplan_user_view_preference';
        } else if (filter == 'sort') {
            type = 'block_myacademicplan_user_sort_preference';
        } else if (filter == 'customfieldvalue') {
            type = 'block_myacademicplan_user_grouping_customfieldvalue_preference';
        } else {
            type = 'block_myacademicplan_user_grouping_preference';
        }

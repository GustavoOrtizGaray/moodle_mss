...
function(
    ...
    var TEMPLATES = {
        COURSES_CARDS: 'block_myacademicplan/view-cards',
        COURSES_LIST: 'block_myacademicplan/view-list',
        COURSES_SUMMARY: 'block_myacademicplan/view-summary',
    ...
    var DEFAULT_PAGED_CONTENT_CONFIG = {
        ...
        persistentLimitKey: 'block_myacademicplan_user_paging_preference'
    };
    ...
    var setCourseHiddenState = function(courseId, status) {
        ...
        return Repository.updateUserPreferences({
            preferences: [
                {
                    type: 'block_myacademicplan_hidden_course_' + courseId,
                    value: status
                }
            ]
        });

 ...
 */
$string['myacademicplan'] = 'Mi Plan Académico';
$string['allincludinghidden'] = 'Todos';
$string['all'] = 'Todos (excepto eliminado de la vista)';
...
$string['list'] = 'List';
$string['myacademicplan:myaddinstance'] = 'Add a new course overview block to Dashboard';
$string['nocustomvalue'] = 'No {$a}';
$string['past'] = 'Past';
$string['pluginname'] = 'Mi Plan Académico';
